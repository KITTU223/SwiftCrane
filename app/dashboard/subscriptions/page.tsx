...
const PLAN_FEATURES = {
  free: [
    ...
    { name: "Avdance analytics", included: false },
    { name: "Priority Support", included: false },
  ],
  pro: [
    { name: "Unlimted repositories", included: true },
    { name: "Unlimted reviews", included: true },
    { name: "Advance code reviews", included: true },
...
export default function SubscriptionPage() {
  ...
  const curretTier = data.user.subscriptionTier as "FREE" | "PRO";
  const isPro = curretTier === "PRO";
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    {data.limits.repositories.limit ?? "ထ"}
                  </Badge>
                </div>
